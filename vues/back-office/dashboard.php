...
<body style="margin:0; font-family:'Segoe UI', Arial, sans-serif; background:#f4f6f9; display:flex;">
    ...
    <div style="width:260px; background:#2c3e50; color:white; height:100vh; padding:25px; box-sizing:border-box; display:flex; flex-direction:column; justify-content:space-between; position:fixed;">
        <div>
            ...
            <ul style="list-style:none; padding:0; margin:30px 0 0 0; line-height:2.8;">
                ...
                <li><a href="#" style="color:#ecf0f1; text-decoration:none;">📝 Gérer les articles</a></li>
                <li><a href="#" style="color:#ecf0f1; text-decoration:none;">👤 Gérer les utilisateurs</a></li>
        ...
        <button id="logout-btn" style="width:100%; padding:12px; background:#c0392b; color:white; border:none; border-radius:4px; font-weight:bold; cursor:pointer;">
            🚪 Déconnexion
        </button>
    </div>
    ...
    <div style="margin-left:260px; flex:1; padding:40px; box-sizing:border-box;">
        ...
        <p style="color:#7f8c8d; margin-top:-10px; margin-bottom:40px;">Statistiques globales de la plateforme.</p>
        ...
        <div style="display:flex; gap:25px; margin-bottom:40px;">
            <div style="flex:1; background:white; padding:25px; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.03); border-left:5px solid #3498db;">
                <h3 style="margin:0; color:#7f8c8d; font-size:0.9em; text-transform:uppercase;">Membres Inscrits</h3>
            ...
            <div style="flex:1; background:white; padding:25px; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.03); border-left:5px solid #2ecc71;">
                <h3 style="margin:0; color:#7f8c8d; font-size:0.9em; text-transform:uppercase;">Articles Publiés</h3>
            ...
            <div style="flex:1; background:white; padding:25px; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.03); border-left:5px solid #9b59b6;">
                <h3 style="margin:0; color:#7f8c8d; font-size:0.9em; text-transform:uppercase;">Messages Échangés</h3>
        ...
        <div style="background:white; padding:30px; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.03);">
            ...
            <p style="color:#95a5a6;">Utilise le menu latéral pour modérer les contenus ou analyser les comptes utilisateurs.</p>
        </div>
    </div>

    <script src="../../assets/js/api.js"></script>
    <script>
        // Sécurité : redirection si pas de token admin
        ...
        async function loadDashboardStats() {
            try {
                // Endpoint corrigé : admin/stats.php (plus de lot4/)
                const response = await apiRequest("admin/stats.php", "GET");
